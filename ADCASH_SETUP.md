...
Your Adcash ad with zone ID `zw4eseomc0` has been integrated into your homepage!
...
```
[Adcash] Script loaded for zone: zw4eseomc0
...
3. You should see requests to:
   - `acscdn.com/script/zw4eseomc0.js`
...
<div class="adcash-ad-container">
  ...
  <div class="flex justify-center">
    <script src="//acscdn.com/script/zw4eseomc0.js"></script>
    <!-- Adcash ad content -->
  </div>
</div>
```
...
1. **Verify zone ID:** `zw4eseomc0` (check Adcash dashboard)
...
- [x] Zone ID configured: `zw4eseomc0`
