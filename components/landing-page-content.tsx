...
function LandingPageInner({ initialRates }: LandingPageContentProps) {
  ...
  // Random currency
  const currencies = [
    "USD", "GBP", "EUR", "CNY", "JPY", "CAD", "AUD", "NZD", "ZAR", "CHF",
    "SEK", "NOK", "DKK", "GHS", "XOF", "XAF", "KES", "UGX", "TZS", "EGP",
    "MAD", "TND", "ZMW", "XOF", "XAF", "CFA", "SAR", "AED", "QAR", "KWD",
    "BHD", "INR", "PKR", "BDT", "GMD", "SLL", "LRD", "CDF", "ETB", "SOS",
  ];
            ...
            <Link href="/guides">
              <Card className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">NGN/USD Exchange Rates</CardTitle>
                  <CardDescription>
            ...
            <Link href="/guides">
              <Card className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Parallel vs Official Rates</CardTitle>
                  <CardDescription>
            ...
            <Link href="/guides">
              <Card className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Optimizing Remittances</CardTitle>
                  <CardDescription>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                ...
                multiple sources including CBN, black market, and parallel rates.
              </p>
          ...
          <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-sm text-gray-400 text-center">
              <p>&copy; {new Date().getFullYear()} NairaMet. All rights reserved.</p>
              <p className="text-xs mt-1">Rates are for informational purposes only. Not financial advice.</p>
            </div>
