...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "Learn about how NairaMet uses cookies and how you can manage your cookie preferences.",
}
      ...
      <div className="space-y-6">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Statistics cookies:</strong> Help us understand how visitors interact with our 
              website by collecting anonymous information.
            </li>
            <li>
              <strong>Marketing cookies:</strong> Used to deliver personalized advertisements and 
          ...
          <ul>
            ...
            <li>
              <strong>Google Analytics:</strong> To analyze website traffic and usage (if applicable)
            </li>
          </ul>
          ...
          <p>
            ...
            button above. You can choose to accept all cookies, reject non-essential cookies, or 
            customize your preferences by category.
          </p>
          <p>
            You can also control cookies through your browser settings. However, please note that 
          ...
          <p>
            ...
            collect explicit consent before setting non-essential cookies. You will see a consent 
            banner on your first visit, where you can choose to accept, decline, or customize your 
            cookie preferences.
          </p>

          <h2>Cookie declaration</h2>
          <p>
            Below is a detailed list of all cookies used on our website, automatically updated by 
        ...
        {cookiebotId ? (
          ...
          <div className="border rounded-lg p-6 bg-muted">
            <p className="text-sm text-muted-foreground">
              ...
              Please add your NEXT_PUBLIC_COOKIEBOT_ID to your environment variables.
            </p>
          </div>
        )}
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            ...
            website or email us at privacy@nairamet.com.
          </p>
        </div>
      </div>
    </div>
