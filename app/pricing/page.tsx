...
import { Check, Crown, Gift, ArrowRight, Shield, CreditCard, Smartphone, Clock, Star, Users, Zap } from "lucide-react"
...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Your data is preserved. You'll just lose access to premium features until you upgrade again.",
    },
    {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <Badge variant="outline" className="text-emerald-700 border-emerald-200 bg-emerald-50 mb-4">
            💳 Simple Pricing
          </Badge>
          ...
          <p className="text-xl text-muted-foreground text-pretty">
            Start free forever, or unlock premium features with our 7-day free trial
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Secure Payment Options</h2>
            <p className="text-muted-foreground">Choose your preferred payment method</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {paymentMethods.map((method, index) => (
              <Card key={index} className={`text-center ${method.popular ? "border-emerald-200" : ""}`}>
                {method.popular && (
                  <Badge className="absolute -top-2 -right-2 bg-emerald-600 text-white">Popular</Badge>
                )}
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-balance">Ready to Upgrade Your FX Trading?</h2>
          <p className="text-xl text-emerald-100 mb-8 text-pretty">
            Join thousands of traders who trust NairaMet for accurate, real-time exchange rates
          </p>
          ...
          <p className="text-sm text-emerald-200 mt-4">No credit card required • Cancel anytime</p>
        </div>
      </section>
    </div>
  )
